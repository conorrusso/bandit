...
def show_welcome(console: Console | None = None) -> None:
    ...
    commands = [
        ...
        (_cmd("bandit ai",      "<vendor>", "--drive"),             "Deep AI/ML risk analysis (D6)"),
        (_cmd("bandit audit",   "<vendor>", "--drive"),             "SOC 2 and ISO gap analysis"),
        (_cmd("bandit legal",   "<vendor>", "--drive"),             "Contract gap analysis (DPA/MSA)"),
